...
public class HomeControllerTest extends ApplicationTest {
    ...
    @Test
    public void ConfirmedCasesIcon(){
        clickOn("#ConfirmedCasesIcon");
    }

    @Test
    public void DeathCasesIcon(){
        clickOn("#DeathCasesIcon");
    }

    @Test
    public void VaccinationIcon(){
        clickOn("#VaccinationIcon");
    }

    @Test
    public void LinearRegressionIcon(){
        clickOn("#LinearRegressionIcon");
    }
}
